...
public class MainActivity extends SampleActivityBase
     ...
     * Callback is defined in resource layout definition.
     */
    public void showCalendar(View vCalendar) {
        ...
        if (ActivityCompat.checkSelfPermission(this, Manifest.permission.READ_CALENDAR)
            ...
            // Contact permissions have been granted. Show the contacts fragment.
            Log.i(TAG,
                    "Calendar permissions have already been granted. Displaying contact details.");
            showCalendarDetails();
        }
    }
        ...
        if (ActivityCompat.shouldShowRequestPermissionRationale(this,
            ...
            Snackbar.make(mLayout, R.string.permission_calendar_rationale,
                    ...
                    .setAction(R.string.ok, new View.OnClickListener() {
                        ...
                        public void onClick(View view) {
                            ActivityCompat
                                    .requestPermissions(MainActivity.this, new String[] {Manifest.permission.READ_CALENDAR},
                                            REQUEST_CALENDAR);
                        }
                    })
                    .show();
